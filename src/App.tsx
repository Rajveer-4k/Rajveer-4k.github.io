...
const heartfeltWords = [
  ...
  { name: "Ashwani Juneja", message: "(Happy Birthday, Ashi ❤️ You’ve always been more than just my elder sister — you’ve been my guide, my protector, and sometimes even my second mom. From childhood memories filled with laughter to the quiet moments when you stood by me without saying a word, your love has shaped who I am today. Your strength inspires me, your kindness humbles me, and your unwavering support gives me courage. No matter how much we grow up, I’ll always look up to you. Thank you for the sacrifices you’ve made and the endless care you show. I’m truly blessed to have you in my life. May this year bring you all the happiness, success, and love you deserve. Stay blessed always. Happy wala birthday 🤗😍)" },
  ...
  { name: "Kulbushan Kapoor", message: "(Ahh, Ashi didi, Apple of our eye. I became her fan, the moment our eyes met. It was twenty-one years ago, the occasion was boy meet girl. As she walked in the restaurant, keeping us waiting for about an hour. And when our eyes met and between smiles, we established a life long relationship of Papa and daughter. She left her cushy job in a bank to take care of young Rajveer. She is very courageous and takes command wherever she goes. We must have done some good deeds to have her as our daughter. I sincerely wish her All the best in her life . 👏👏)" }, 
  ...
  { name: "Kunal Khurana", message: "(Ashima di has been one of the most caring and understanding persons I have ever met. She is very balanced and manages everything well. She also has a slightly funny side to her which comes out occasionally. She is a rare gem 💎 ❤️ 🤗)" },
  ...
  { name: "Shashank Jain", message: "(Happy Birthday, Ashima! 🎉🎂 To the only person who can draw a movie that might appear confusing to the world, but feels absolutely perfect to our team. From Khalnayak to Yeh Jawaani Hai Deewani to Munna Bhai MBBS, you’ve somehow made every round unforgettable in your own way. Wishing you more such games, laughs and memories. Have the best birthday.)" },
  ...
  { name: "Ankit Aggarwal", message: "(Happy Birthday to someone who feels less like a friend and more like family. 🎉 From countless family vacations to endless laughter and shared memories, every trip has been brighter because of you. Our families may have started as friends, but over the years, the bond has grown into something truly beautiful. Here’s to many more holidays, celebrations, and unforgettable moments together. May this year bring you happiness, success, and everything your heart wishes for. Cheers 🥂)" },
  { name: "Aman Mathur", message: "(Ashima had been a dear friend since last 11 years, a warm compassionate mature personality she had been always there for us during our high’s and low’s…. from card to chai parties, memorable vacations and many more lovely times, we have had few of our best times together. Her immense support and concern during my surgery will always remain itched in my heart. Her passion for fitness and nutrition is contagious and inspirational. I wish her all the best in life.. may she gets whatever her beautiful  heart desires.. Love you load’s my dear friend…)" },
  { name: "Vipul Mathur", message: "(Music and fitness, two passions of Ashima! I remember the Music Nights at Spa where we all enthusiastically gathered…super fun. Fitness…A role model for all of us on how to follow your dreams and make it happen. Happy Birthday Ashima! Wishing you a wonderful year and life ahead !)" },
  ...
  { name: "Sumit Sharma", message: "To the friend who is so selfless and caring that you would probably offer to help the delivery guy carry your own birthday cake up the stairs. I was going to get you a massive triple-chocolate cake, but I figured you would just analyze the glycemic index and send it back. Since Holi is around the corner, thought sending some colors & water balloons, but  then would have already calculated the bacterial count of the water and the pH level of the dye, so no ‘Colors of Doom’ for you either 😊 In all seriousness, Ashima, you are the most grounded, supportive person I know. Thank you for always being there to catch us when we fall (and for probably checking our vitals immediately after).Have a birthday that’s as healthy as your morning meal.)" },
  ...
  { name: "Nitish Jain", message: "(Ashima is one of those rare people whose warmth, charm, and thoughtfulness leave a lasting imprint on everyone around her. Primanti truly doesn’t feel the same without her presence. May her flame of fitness-fueled passion continue to burn bright, inspiring everyone she touches along the way. May the Almighty bless her with endless happiness and success in all that she pursues. She will always remain a special part of our hearts.)" },
  ...
  { name: "Neelam Kaur", message: "(Ashi ♥️ Kudiye tu flower bhi hai aur fire bhi 😘 The buddy who loves unconditionally and has always been like a sister ♥️You are my buddy with a kind heart  who has always offered genuine care and positivity acting as sunshine. Your selflessness ,your patience are rare posssesions♥️U and Rahul are family and am so grateful to have you guys in my life. Wishing you a year as wonderful as you are♥️ Happy Birthday Gorgeous 🥰)" },
  { name: "Jaggi Singh", message: "(Wishing you a year full of beautiful moments, and lots of laughter. Keep shining and inspiring everyone around you and success to everything you’ve been manifesting. Have an amazing celebration! Happy Birthday my dear dear friend Ashi🎂💐✨ 47 looks seriously good on you!🥂💓)" },
  { name: "Deepti Mondol", message: "(Happy birthday !!! To my friend who feels like family. Dearest Ashi we may not always agree but I cherish deeply the bond we share . May this year return to you the warmth and love  you so generously give to everyone around you. Love and hugs forever ever.)" },
  { name: "Suvonath Mondol", message: "(I’m truly proud of the way you’re committed to your fitness journey with discipline and heart. It takes real courage to build a career around your passion, and you’re doing exactly that. May this year bring you greater strength, sharper focus, meaningful opportunities, and everything you’re working so hard for. The best version of you is only just beginning to unfold! Happy Birthday, Ashima … Tagda Raho 💪🏽🥂⚡️)" }, 
  ...
  { name: "Pooja & Rajnesh Gehani", message: "(Dear Ashima, Our best wishes always for you. May you be blessed with happiness and laughter. May all your dreams come true. Happy Birthday ! )" },
  {name: "Suji Guha", message: "(Hi Ashima, Its your birthday 🎂 Our friendship is 2 decades old now. From Kolkata to Delhi, a journey full of achievements for you🏆💃. The courage/strength and hardship u have is remarkable. Your suggestions and approach towards life has helped me too ✋️ 😊 🙂 .... Wish you a wonderful life and a joyful year 🎂)" }, 
  {name: "Arnab Guha", message: "(Loading.... Please wait)" } 
];
      ...
      <footer className="bg-black text-zinc-400 py-20 text-center relative overflow-hidden border-t border-yellow-900/30">
        ...
        <div className="max-w-3xl mx-auto px-4 relative z-10">
          ...
          <div className="space-y-4 text-xl font-serif">
            ...
            <p><span className="text-yellow-400 font-semibold">Special thanks to everyone who took a few minutes out of their busy schedule to send a message.</span></p>
